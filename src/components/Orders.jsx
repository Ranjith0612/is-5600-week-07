...
const Orders = () => {
  ...
  /**
   * Create a `fetchOrders` function that retrieves all orders from the database
   * Using the `useEffect` hook to update the existing `orders` state object when `fetchOrders` is complete
   **/
